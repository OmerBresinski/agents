      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-2 border-b border-border">
          <div className="px-8 py-8">
            ...
            <h2 className="mt-3 font-heading text-xl font-normal">
              Pick an Agent
            </h2>
          ...
          <div className="border-l border-border px-8 py-8">
            <span className="text-[11px] font-medium tracking-widest text-muted-foreground uppercase">
              Step 2
            </span>
            <h2 className="mt-3 font-heading text-xl font-normal">
        ...
        <div className="px-8 py-8">
          ...
          <h2 className="mt-3 font-heading text-xl font-normal">Quick Setup</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Add this to{" "}
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
              ~/.ssh/config
            </code>{" "}
            for easier access. Then connect with just{" "}
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">
              ssh agent-1
            </code>
            .
